...
// Type: HealthRegenerationMultiplier
...
#nullable disable
public class HealthRegenerationMultiplier : EffectDefinitionSingle
{
  ...
  public HealthRegenerationMultiplier(int ID)
    : base(ID)
  {
    EffectInstance<float, HealthRegenerationMultiplier> effectInstance = new EffectInstance<float, HealthRegenerationMultiplier>();
    SerializeFactory.RegisterType<EffectInstance<float, HealthRegenerationMultiplier>>(effectInstance, effectInstance.Identifier);
  }
  ...
  {
    PeriodicEffectsManager.Apply<float, HealthRegenerationMultiplier>(this, Entity);
  }

  public override void Remove(Entity Entity, int numberOfStacks)
  {
    PeriodicEffectsManager.Remove<float, HealthRegenerationMultiplier>(this, numberOfStacks, Entity);
  }
}
