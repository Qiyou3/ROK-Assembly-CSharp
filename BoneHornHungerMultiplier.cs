...
#nullable disable
public class BoneHornHungerMultiplier : HungerMultiplier
{
  ...
  private string Description_field = "Food Consumption";
  ...
  public BoneHornHungerMultiplier(int ID)
    : base(ID)
  {
    EffectInstance<float, BoneHornHungerMultiplier> effectInstance = new EffectInstance<float, BoneHornHungerMultiplier>();
    SerializeFactory.RegisterType<EffectInstance<float, BoneHornHungerMultiplier>>(effectInstance, effectInstance.Identifier);
  }
  ...
  {
    PeriodicEffectsManager.Apply<float, BoneHornHungerMultiplier>(this, Entity);
  }

  public override void Remove(Entity Entity, int numberOfStacks)
  {
    PeriodicEffectsManager.Remove<float, BoneHornHungerMultiplier>(this, numberOfStacks, Entity);
  }
}
